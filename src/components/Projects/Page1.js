...
function Page1(props) {
    ...
    const [go, setplay] = useState(false);
    return ( 
    <div className={classes.list}>
        <p className={classes.newhits}>Popular projects</p>
        <div className={classes.row}>
            <div className={classes.song} onMouseOver={() => {props.setProject(0); setIsHovering(1)}} onMouseLeave={() => {setIsHovering(0)}} onClick={go === false ? props.handleClick : null}>
                <div className={classes.artname}>
                <img className={classes.art} src={parku} ></img>
                <div className={classes.name}>ParkU</div>
                </div>

            {isHovering == 1 ? <a onMouseOver={() => setplay(true)} onMouseLeave={() => setplay(false)} href={list[isHovering - 1].link}><img src={play}  className={classes.play}/> </a>: null}
            </div>
            <div className={classes.song} onMouseOver={() => {props.setProject(1); setIsHovering(2)}} onMouseLeave={() => {setIsHovering(0)}} onClick={go === false ? props.handleClick : null}>
                <div className={classes.artname}>
                <img className={classes.art} src={nftuc} ></img>
                <div className={classes.name}>NFTUC</div>
                </div>

                {isHovering == 2 ? <a href={list[isHovering - 1].link}onMouseOver={() => setplay(true)} onMouseLeave={() => setplay(false)}><img src={play} className={classes.play}/> </a>: null}
            </div>
        </div>
        <div className={classes.row}>
           <div className={classes.song} onMouseOver={() => {props.setProject(2); setIsHovering(3)}} onMouseLeave={() => {setIsHovering(0)}} onClick={go === false ? props.handleClick : null}>
                <div className={classes.artname}>
                <img className={classes.art} src={Fundergrad} ></img>
                <div className={classes.name}>Fundergrad</div>
                </div>

                {isHovering == 3 ? <a href={list[isHovering - 1].link}onMouseOver={() => setplay(true)} onMouseLeave={() => setplay(false)}><img src={play} className={classes.play}/> </a>: null}
            </div>
           <div className={classes.song} onMouseOver={() => {props.setProject(3); setIsHovering(4)}} onMouseLeave={() => {setIsHovering(0)}} onClick={go === false ? props.handleClick : null}>
                <div className={classes.artname}>
                <img className={classes.art} src={ss} ></img>
                <div className={classes.name}>Secret Shop</div>
                </div>

                {isHovering == 4 ? <a href={list[isHovering - 1].link}onMouseOver={() => setplay(true)} onMouseLeave={() => setplay(false)}><img src={play} className={classes.play}/> </a>: null}
            </div>
        </div>
        <div className={classes.row}>
           <div className={classes.song} onMouseOver={() => {props.setProject(4); setIsHovering(5)}} onMouseLeave={() => {setIsHovering(0)}} onClick={go === false ? props.handleClick : null}>
                <div className={classes.artname}>
                <img className={classes.art} src={Excelerate} ></img>
                <div className={classes.name}>Excelerate (In Progress)</div>
                </div>

                {isHovering == 5 ? <a href={list[isHovering - 1].link}onMouseOver={() => setplay(true)} onMouseLeave={() => setplay(false)}><img src={play} className={classes.play}/> </a>: null}
            </div>
            <div className={classes.song2} onMouseOver={() => {props.setProject(4); setIsHovering(4)}} onMouseLeave={() => {setIsHovering(0)}} onClick={go === false ? props.handleClick : null}>
            </div>
        </div>
